...
//                    dataBinding.productRating.text = it.product.first()
                    slideToHalf()
                },
                onError = {
    ...
    override fun handleResult(rawResult: Result?) {
        ...
        if (cameraState == CameraState.SCAN && rawResult != null) {
            ...
            viewModel.getComments(Integer.parseInt(data[0]), Integer.parseInt(data[1]))
    ...
    private fun askPermission() {
        ...
        if (permission != PackageManager.PERMISSION_GRANTED) {
            ...
            showErrorDialog(ServerError(getString(R.string.cameraPermission)))
        }
    }
